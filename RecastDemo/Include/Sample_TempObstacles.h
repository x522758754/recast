...
public:
	...
	void loadObstaclesAll(const char* path);
	void saveObstaclesAll(const char* path);

	///加载障碍物文件
	void loadObstacles(const std::string& path) const;

	void saveObstacles(const std::string& path);
